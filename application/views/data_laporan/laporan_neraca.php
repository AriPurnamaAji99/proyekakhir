    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="newKategoriModalLabel">Form Input Data Laporan Neraca</h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
            <form action="<?= base_url('kirim/tambah_laporan_neraca') ?>" method="post" enctype="multipart/form-data">
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        <label for="nama_laporan">Laporan Neraca <span class="text-danger">*</span></label>
    ...
    <div class="modal fade" id="editLaporan<?= $row->id_laporan; ?>" tabindex="-1" aria-labelledby="editKategoriLabel" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <form action="<?= base_url('kirim/edit_laporan_neraca/') . $row->id_laporan; ?>" method="post" enctype="multipart/form-data">
                    <div class="modal-body">
                        <div class="mb-2">
