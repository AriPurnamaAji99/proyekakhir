...
<div class="container-fluid">
    ...
    <!-- <?php foreach ($barang_kosong as $brg) : ?>
        <?php if ($brg->jml == 0) : ?>
            <p></p>
        <?php else : ?>
            <div class="alert alert-danger" role="alert">
                <i class="fas fa-info-circle"></i><strong> Perhatian</strong> terdapat <strong><?= $brg->jml; ?></strong> barang yang stoknya kurang dari 5, silahkan cek barang <a href="<?= base_url('barang/stok') ?>" class="alert-link">disini</a>.
            </div>
        <?php endif; ?>
    <?php endforeach; ?> -->
