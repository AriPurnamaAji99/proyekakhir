...
<div class="container-fluid">
    ...
    <div class="card shadow mb-4">
        ...
        <div class="card-body">
            <form action="<?= base_url('penjualan/data_penjualan_by_tanggal') ?>" method="POST">
                <div class="row">
                    <div class="col-md-3">
                    ...
                    <div class="col-md-3">
                        <div class="form-group"><br>
                            ...
                            <a href="<?= base_url('penjualan/data_penjualan');  ?>" class="btn btn-secondary btn-sm mt-2"><i class="fas fa-sync-alt"></i></a>
                        </div>
                    </div>
                </div>
            </form>
                    ...
                    <tbody>
                        ...
                        foreach ($rows as $row) : ?>
                            <tr>
                                ...
                                <td><a href="<?= base_url('penjualan/detail_penjualan/') . $row->kode_penjualan; ?>" class="badge badge-info">Detail</a></td>
                            </tr>
                        <?php
