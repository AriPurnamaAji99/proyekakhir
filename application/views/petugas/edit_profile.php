            ...
            <div class="card shadow mb-4">
                <div class="row">
                    <div class="col-md-12">
                        <div class="card-body">
                            <div class="col-lg-8">
                                <form action="<?= base_url('petugas/editProfile') ?>" method="post" enctype="multipart/form-data">
                                    <div class="row mb-3">
                                    ...
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-sm-9">
                                            <textarea name="alamat" id="alamat" class="form-control" value="<?= $user['alamat']; ?>"><?= $user['alamat']; ?></textarea>
                                    ...
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text" class="form-control" id="no_hp" autocomplete="off" name="no_hp" value="<?= $user['no_hp']; ?>" minlength="11" maxlength="13" oninvalid="this.setCustomValidity('No Telp belum sesuai')" oninput="setCustomValidity('')" onkeypress="return restrictAlphabets(event)">
