        ...
        <div class="card-body">
            <div class="table-responsive">
                <table class="table table-bordered table-hover" id="dataTable" width="100%" cellspacing="0">
                    ...
                    <tbody>
                        <?php $data = $this->db->query("SELECT * FROM data_laporan ORDER BY  DESC")->result(); ?>
    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="newKategoriModalLabel">Form Input Data Laporan Penjualan</h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
            <form action="<?= base_url('kirim/tambah') ?>" method="post" enctype="multipart/form-data">
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        <label for="laporan_penjualan">Laporan Penjualan <span class="text-danger">*</span></label>
                        <!-- <input type="file" class="form-control" id="laporan_penjualan" name="laporan_penjualan" required oninvalid="this.setCustomValidity('Laporan tidak boleh kosong')" oninput="setCustomValidity('')"> -->
                        <div class="custom-file">
                            <input type="file" class="custom-file-input" id="laporan_penjualan" name="laporan_penjualan" required oninvalid="this.setCustomValidity('Laporan tidak boleh kosong')" oninput="setCustomValidity('')">
    ...
    <div class="modal fade" id="editLaporan<?= $row->id_laporan; ?>" tabindex="-1" aria-labelledby="editKategoriLabel" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="<?= base_url('kirim/edit/') . $row->id_laporan; ?>" method="post" enctype="multipart/form-data">
                        <div class="mb-2">
                        ...
                        <div class="mb-2">
                            <label for="laporan_penjualan">Laporan Penjualan <span class="text-danger">*</span></label>
                            <!-- <input type="file" class="form-control" id="laporan_penjualan" name="laporan_penjualan" value="<?= $row->laporan_penjualan; ?>" required oninvalid="this.setCustomValidity('Laporan tidak boleh kosong')" oninput="setCustomValidity('')"> -->
                            <div class="custom-file">
                                <input type="file" class="custom-file-input" id="laporan_penjualan" name="laporan_penjualan" value="<?= $row->laporan_penjualan; ?>">
                                <label class="custom-file-label" for="" id="label"><?= $row->laporan_penjualan; ?></label>
                            </div>
                            <small class="text-muted"><i>*format file: pdf</i></small>
                        </div>
                        <div class="mb-2">
