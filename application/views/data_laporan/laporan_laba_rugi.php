        ...
        <div class="card-body">
            <div class="table-responsive">
                <table class="table table-bordered table-hover" id="dataTable" width="100%" cellspacing="0">
                    ...
                    <tbody>
                        <?php $rows = $this->db->query("SELECT * FROM data_laporan_laba_rugi ORDER BY created_at DESC")->result(); ?>
    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="newKategoriModalLabel">Form Input Data Laporan Laba Rugi</h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
            <form action="<?= base_url('kirim/tambah_laporan_laba_rugi') ?>" method="post" enctype="multipart/form-data">
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        <label for="nama_laporan">Laporan Laba Rugi <span class="text-danger">*</span></label>
    ...
    <div class="modal fade" id="editLaporan<?= $row->id_laporan; ?>" tabindex="-1" aria-labelledby="editKategoriLabel" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="<?= base_url('kirim/edit_laporan_laba_rugi/') . $row->id_laporan; ?>" method="post" enctype="multipart/form-data">
                        <div class="mb-2">
                            ...
                            <input type="date" class="form-control" id="tgl_awal" name="tgl_awal" value="<?= $row->tgl_awal; ?>" required autocomplete="off" oninvalid="this.setCustomValidity('Tanggal tidak boleh kosong')" oninput="setCustomValidity('')">
                        </div>
                        <div class="mb-2">
                            <label for="tgl_akhir" class="col-form-label">Tanggal Akhir <span class="text-danger">*</span></label>
                            <input type="date" class="form-control" id="tgl_akhir" name="tgl_akhir" value="<?= $row->tgl_akhir; ?>" required autocomplete="off" oninvalid="this.setCustomValidity('Tanggal tidak boleh kosong')" oninput="setCustomValidity('')">
                        </div>
                        <div class="mb-2">
                            <label for="nama_laporan">Laporan Laba Rugi <span class="text-danger">*</span></label>
                            <div class="custom-file">
                                <input type="file" class="custom-file-input" id="nama_laporan" name="nama_laporan" value="<?= $row->nama_laporan; ?>" oninvalid="this.setCustomValidity('Laporan tidak boleh kosong')" oninput="setCustomValidity('')">
